/* BEGIN ANCHOR (CPACC_OPEN_DOOR_ACCESSIBILITY_LAB_APP_V1) */
(function () {
    "use strict";
    ...
    function makeEmptyStats() {
        return {
            ...
            domains: {
                ...
                domain5: { answered: 0, correct: 0, incorrect: 0 }
            }
        };
    }
    ...
    function getDomainTitle(domainId) {
        if (CPACC_LAB_DATA.domains[domainId]) {
            return CPACC_LAB_DATA.domains[domainId].title;
        }
    ...
    function showQuestion(moveFocus) {
        ...
        document.title = "Question " + String(state.currentIndex + 1) + " - " + getModeLabel(state.mode).replace(" mode", "") + " - CPACC - OpenDoorAccessibilityLab";
        updateLocationText();
        updateCounter();
    ...
    function showStatistics() {
        ...
        document.title = "Statistics - CPACC - OpenDoorAccessibilityLab";
        if (els.returnResultsButton) {
            els.returnResultsButton.hidden = true;
        }
        if (els.reviewStatisticsButton) {
    ...
    function renderStatistics() {
        ...
        Object.keys(CPACC_LAB_DATA.domains).forEach(function (domainId) {
    ...
    function returnHome() {
        ...
        document.title = "CPACC - OpenDoorAccessibilityLab";
    ...
    function completeSprint() {
        ...
        els.nextQuestionButton.hidden = false;
        els.skipButton.hidden = false;
        document.title = "Sprint Complete - CPACC - OpenDoorAccessibilityLab";
    ...
    function showMissedReview(index) {
        ...
        document.title = "Review Missed Question - CPACC - OpenDoorAccessibilityLab";
    ...
    function exportChallenges() {
        ...
        lines.push("CPACC - OpenDoorAccessibilityLab");
        ...
        link.download = "CPACC-OpenDoorAccessibilityLab-Challenges-" + dateStamp + ".txt";
    ...
    function showReviewComplete() {
        ...
        document.title = "Review Complete - CPACC - OpenDoorAccessibilityLab";
...
/* END ANCHOR (CPACC_OPEN_DOOR_ACCESSIBILITY_LAB_APP_V1) */
